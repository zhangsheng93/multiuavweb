const i18n = {
  en: {
    ...
    "leaderboard.costNote": "* The Agent4Drone + deepseek-v4-pro full benchmark run cost approximately $55 across more than 35K API requests, with roughly 13M output tokens, 84M cache-miss input tokens, and 1.9B cache-hit input tokens, based on the API usage records reported in the paper.",
    "table.rank": "Rank",
    "table.method": "Method",
  ...
  zh: {
    ...
    "leaderboard.costNote": "* Agent4Drone + deepseek-v4-pro 全量 Benchmark 运行约花费 400 元人民币，覆盖超过 3.5 万次 API 请求，约消耗 1300 万输出 token、8400 万未命中缓存输入 token 和 19 亿命中缓存输入 token，依据论文中报告的 API 使用记录。",
    "table.rank": "排名",
    "table.method": "方法",
    "table.backend": "模型后端",
